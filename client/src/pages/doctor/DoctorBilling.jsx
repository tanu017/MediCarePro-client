...
import { BillDetailsModal } from '../../components/common';
...
const DoctorBilling = () => {
  ...
  const fetchBills = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await billingAPI.getDoctorBills();
        ...
        <div className="py-4 sm:py-6 m-2 sm:m-4 md:pl-16 lg:mx-auto">
          ...
          <div className="mb-4 sm:mb-6 md:mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-2">Patient Billing</h1>
                <p className="text-sm sm:text-base text-gray-600">View billing information for your patients</p>
              </div>
              <button
                onClick={fetchBills}
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search by patient name, description, or appointment reason..."
                    value={searchTerm}
                  ...
                  <div className="space-y-1 sm:space-y-2 mb-3 sm:mb-4">
                    ...
                    {bill.patientId && (
                      <div className="flex items-center space-x-2 text-gray-600">
                        ...
                        <span className="text-sm">{bill.patientId.userId?.name || 'Unknown Patient'}</span>
                      </div>
                    )}
                    {bill.appointmentId && (
                      <div className="flex items-center space-x-2 text-gray-600">
